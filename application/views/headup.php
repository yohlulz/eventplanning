<div id="header" class="center">
	...
	<div id="authenticate">
            <ul>
			<?php if($cart) {
				echo '<li><div id="cart" lang="'.(checkLanguage()=='english'?'en':checkLanguage()).'" head="'.lang('website_title').'" foot="'.lang('website_title').' PayPal" email="'.getConfigItem('contact_to_email').'" >Cart</div></li>';
			}?>
