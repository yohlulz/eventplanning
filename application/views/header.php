...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php echo checkLanguage(); ?>"  xml:lang="<?php echo checkLanguage(); ?>">
<head>
	...
	<script src="resource/js/sharre.js" type="text/javascript" charset="utf-8"></script>
	...
	<script src="resource/js/ajaxpaypal-1.1.0/paypal.js" type="text/javascript"></script> 
