...
;(function ( $, window, document, undefined ) {
  ...
  defaults = {
    ...
    text: document.title,
    urlCurl: 'ajax/share',  //PHP script for google plus...
  ...
  Plugin.prototype.init = function () {
    ...
    if(this.options.urlCurl !== ''){
      urlJson.googlePlus = this.options.urlCurl + '/googlePlus'; // PHP script for GooglePlus...
      urlJson.stumbleupon = this.options.urlCurl + '/stumbleupon'; // PHP script for Stumbleupon...
      urlJson.pinterest = this.options.urlCurl + '/pinterest'; // PHP script for Pinterest...
    }
