...
DC.cart.lang_ro ={
    ...
    cartwidget:'%S produs(e) in cos',
    
    button_update   :'update',
    button_delete   :'Sterge',
    button_billing  :'Check Out',
    button_cart     :'Review Cart',
    button_shipping :'Editare adresa ',
    button_cancel   :'Anulare',
    
    label_total     :'Total',
    label_item_info  :'Aveti %S produs(e) in cos.',
    label_noitem     :'Nu aveti niciun produs in cos',   
    label_shipping_info  :'Va rugam introduceti informatiile destinatarului. Costul total: %S.',
    
    label_item_cost  :'Aveti %S produs(e) in cos si cost %A.',
    label_shipping_cost :'Costul total pentru transport este %S.',
    label_total_cost :'Cantitatea totala este %S.',
    label_payment_info  :'Comanda este afisata mai jos. Parasiti aceasta pagina prin apasarea butonului de mai jos.',     
...
DC.cart.lang_ro.Country = DC.cart.lang_en.Country;
DC.cart.lang_ro.addressform = [
    [
        {'id':'firstname','type':'textinput','label':'First Name','alt':'Please enter first name'},
        {'id':'lastname','type':'textinput','label':'Last Name','alt':'Please enter last name'},
    ],
    ...
    {'id':'country','type':'combobox','label':'Country','alt':'help here','data':DC.cart.lang_ro.Country,'dataKey':'code'},
    {'id':'phone','type':'textinput','label':'Contact No.','alt':'Please Contact No.'}
];
